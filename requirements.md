...
5. Search for User
- **Pre-condition:** There are no restrictions to what someone can search for. (Specifically, they can type anything in the search bar and our program will search for it, regardless of what they type)
